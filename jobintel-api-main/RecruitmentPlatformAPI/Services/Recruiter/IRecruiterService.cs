...
namespace RecruitmentPlatformAPI.Services.Recruiter
{
    public interface IRecruiterService
    {
        ...
        Task<ProfileResponseDto> UpdateCompanyNameAsync(int userId, UpdateCompanyNameDto dto);
        Task<ProfileResponseDto> UpdateCompanyInfoPartialAsync(int userId, UpdateRecruiterCompanyInfoDto dto);
    }
}
